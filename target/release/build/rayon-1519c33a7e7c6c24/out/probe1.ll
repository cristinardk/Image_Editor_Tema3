...
@alloc_6aa9f54c8ef61ba4c833e6e1aea35fce = private unnamed_addr constant <{ [89 x i8] }> <{ [89 x i8] c"/rustc/9b00956e56009bab2aa15d7bff10916599e3d6d6/library/core/src/iter/adapters/step_by.rs" }>, align 1
@alloc_37424850771d1d193ce67a391d95e8c4 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc_6aa9f54c8ef61ba4c833e6e1aea35fce, [16 x i8] c"Y\00\00\00\00\00\00\00!\00\00\00\09\00\00\00" }>, align 8

; core::iter::traits::iterator::Iterator::rev
; Function Attrs: inlinehint nonlazybind uwtable
define void @_ZN4core4iter6traits8iterator8Iterator3rev17h3093fa38d1ac5163E(ptr sret([24 x i8]) align 8 %_0, ptr align 8 %self) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint nonlazybind uwtable
define void @_ZN4core4iter6traits8iterator8Iterator7step_by17h18fdfe7c904cd3a1E(ptr sret([24 x i8]) align 8 %_0, i32 %self.0, i32 %self.1, i64 %step) unnamed_addr #0 {
start:
; call core::iter::adapters::step_by::StepBy<I>::new
  call void @"_ZN4core4iter8adapters7step_by15StepBy$LT$I$GT$3new17hf8cad71d38c5fc8dE"(ptr sret([24 x i8]) align 8 %_0, i32 %self.0, i32 %self.1, i64 %step)
  ret void
}

; core::iter::adapters::step_by::StepBy<I>::new
; Function Attrs: inlinehint nonlazybind uwtable
define void @"_ZN4core4iter8adapters7step_by15StepBy$LT$I$GT$3new17hf8cad71d38c5fc8dE"(ptr sret([24 x i8]) align 8 %_0, i32 %iter.0, i32 %iter.1, i64 %step) unnamed_addr #0 personality ptr @rust_eh_personality {
start:
...
; invoke core::panicking::panic
  invoke void @_ZN4core9panicking5panic17h8ddd58dc57c2dc00E(ptr align 1 @alloc_4aead6e2018a46d0df208d5729447de7, i64 27, ptr align 8 @alloc_37424850771d1d193ce67a391d95e8c4) #4
          to label %unreachable unwind label %cleanup

bb1:                                              ; preds = %start
  store i8 0, ptr %_7, align 1
; invoke <T as core::iter::adapters::step_by::SpecRangeSetup<T>>::setup
  %2 = invoke { i32, i32 } @"_ZN76_$LT$T$u20$as$u20$core..iter..adapters..step_by..SpecRangeSetup$LT$T$GT$$GT$5setup17hf21bd55c220417e1E"(i32 %iter.0, i32 %iter.1, i64 %step)
...
; Function Attrs: inlinehint nonlazybind uwtable
define { i32, i32 } @"_ZN76_$LT$T$u20$as$u20$core..iter..adapters..step_by..SpecRangeSetup$LT$T$GT$$GT$5setup17hf21bd55c220417e1E"(i32 %inner.0, i32 %inner.1, i64 %_step) unnamed_addr #0 {
start:
...
; call core::iter::traits::iterator::Iterator::step_by
  call void @_ZN4core4iter6traits8iterator8Iterator7step_by17h18fdfe7c904cd3a1E(ptr sret([24 x i8]) align 8 %_2, i32 %1, i32 %3, i64 2)
; call core::iter::traits::iterator::Iterator::rev
  call void @_ZN4core4iter6traits8iterator8Iterator3rev17h3093fa38d1ac5163E(ptr sret([24 x i8]) align 8 %_1, ptr align 8 %_2)
  ret void
}
...
declare void @_ZN4core9panicking5panic17h8ddd58dc57c2dc00E(ptr align 1, i64, ptr align 8) unnamed_addr #3
